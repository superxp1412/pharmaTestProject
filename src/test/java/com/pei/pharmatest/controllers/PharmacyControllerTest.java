...
class PharmacyControllerTest {
    ...
    void getAllPharmacies_ShouldReturnPharmaciesList() throws Exception {
        ...
        pharmacy1.setContractedDrugs(new HashSet<>(List.of(drug1)));
        ...
        // When & Then
        mockMvc.perform(get("/api/v1/pharmacies").contentType(MediaType.APPLICATION_JSON))
    ...
    void createPrescription_ShouldReturnNotFound_WhenPharmacyNotFound() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/pharmacies/{pharmacyId}/prescriptions", pharmacyId)
                ...
                .andExpect(jsonPath("$.error").value("Resource not found")).andExpect(
                        jsonPath("$.message").value("Pharmacy not found with id: " + pharmacyId));
    }
